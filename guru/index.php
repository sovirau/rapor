            ...
            <ul class="nav navbar-right top-nav">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li>
                            <a href="?pages=edit_profil&kode_guru=<?php echo $id; ?>"><i class="fa fa-fw fa-user"></i> Profile</a>
                        </li>
                        <li class="divider"></li>
                        <li>
                ...
                <div class="col-md-12">
                    ...
                    <div class="navbar-collapse collapse" id="bs-example-navbar-collapse-1">
                        <ul id="menu-top" class="nav navbar-nav navbar-right">
                            ...
                            <li><a href="?pages=data_kompetensi">Kompetensi</a></li>
                            <li><a href="?pages=nilai">Nilai</a></li> 
